...
<body>
<h1>コメント置き場</h1>
更新はフォームをカラにしてからF5でどうぞ
<br/>
<form action="main_form2-15.php" method="post">
	<!-- フォーム作成 main_form2-15.phpに送信 -->
	名前:<br/>
...
<a href = http://co-622.it.99sv-coco.com/mission_2-15/delete_form2-15.html>削除フォーム</a><br/>
<a href = http://co-622.it.99sv-coco.com/mission_2-15/edit_form2-15.html>編集フォーム</a><br/>
<h1>みんなのコメント</h1><br/>
