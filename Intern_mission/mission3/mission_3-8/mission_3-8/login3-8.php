...
//MySQLからユーザーを確認
	if($formIsFilled){
		...
		if($password === $result['password']){
			...
			$_SESSION['login']='1';
			header("Location:http://co-622.it.99sv-coco.com/mission_3-8/main_form3-8.php");
			exit;
		}else{
			echo "ちがいます";
		}
...
<html>
    ...
    <body>
    	<h3>ログインしやがれ</h3>
    	<form action="login3-8.php" method="post">
			ID:<br/>
		...
		<?php if(!$formIsFilled){ ?>
			すべて入力してください<br>
		<?php } ?>
		<a href = http://co-622.it.99sv-coco.com/mission_3-8/regist_form3-8.html>登録フォーム</a><br/>
    </body>
</html>