...
if(!isset($_SESSION['login'])){
	header("Location:http://co-622.it.99sv-coco.com/mission_3-7/login3-7.php");
	exit();
}else{
	$name = $_SESSION['name'];
}
...
<form action="main_form3-7.php" method="post">
	<!-- フォーム作成 main_form3-7.phpに送信 -->
	名前:<br/>
	<input type="text" name="name" value="<?=$name?>" size="10"/><br/>
	コメント:<br/>
...
<a href = http://co-622.it.99sv-coco.com/mission_3-7/delete_form3-7.html>削除フォーム</a><br/>
<a href = http://co-622.it.99sv-coco.com/mission_3-7/edit_form3-7.html>編集フォーム</a><br/>
<a href = http://co-622.it.99sv-coco.com/mission_3-7/logout3-7.php>ログアウト</a><br/>
<h1>みんなのコメント</h1><br/>
